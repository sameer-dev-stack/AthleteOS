# Brain — Master Memory (compressed project intelligence)

- **Project:** AthleteOS — the business operating system for student-athletes (NIL).
- **Stack:** Next.js 14 (App Router), TypeScript 5, Tailwind (dark-only, accent `#C6FF3D`),
...
- **Live (canonical):** https://www.nilcard.app | **Live (Vercel deploy):** https://athlete-os-vert.vercel.app | **Repo:** github.com/sameer-dev-stack/AthleteOS
