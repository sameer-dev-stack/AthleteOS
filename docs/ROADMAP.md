...
| **Phase 3** | DONE | **Public athlete card** — `www.nilcard.app/username` |
...
**Goal:** The core identity layer — a fast, shareable public profile at `www.nilcard.app/username`.
...
**Definition of done:** An athlete can share `www.nilcard.app/their-name` to a phone that loads in <1 second on a mobile browser.
...
- [ ] Branded team landing page (`www.nilcard.app/team/stanford-basketball`)
