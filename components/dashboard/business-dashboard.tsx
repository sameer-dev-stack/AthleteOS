        ...
        <div className="space-y-3">
          ...
          <div className="flex items-center justify-between gap-2 pt-1">
            <button
              ...
              className="flex-1 inline-flex items-center justify-center gap-1.5 rounded-xl bg-accent/15 border border-accent/30 py-2 text-xs font-bold text-accent hover:bg-accent/25 transition-colors"
            >
            ...
            <button
              onClick={handleShareCard}
              className="inline-flex items-center justify-center gap-1.5 rounded-xl border border-white/[0.08] bg-white/[0.03] px-3 py-2 text-xs font-semibold text-white/70 hover:bg-white/[0.06] hover:text-white transition-colors"
            >
