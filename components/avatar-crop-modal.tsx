  ...
  return createPortal(
    ...
    >
      <div
        ...
        className="w-full max-w-2xl rounded-2xl border border-white/[0.08] bg-[#111113] p-5 shadow-2xl sm:p-6"
      >
        ...
        <div className="flex flex-col gap-5 sm:flex-row">
          {/* Cropper */}
          <div className="relative flex-1 aspect-square w-full overflow-hidden rounded-xl border border-white/[0.06] sm:aspect-auto sm:min-h-[320px]">
            <Cropper
              image={imageUrl}
              crop={crop}
              zoom={zoom}
          ...
          {/* Right column: preview + zoom + actions */}
          <div className="flex w-full flex-col gap-5 sm:w-64 sm:flex-shrink-0">
            {/* Badge preview */}
            <div className="flex flex-col items-center gap-2">
              <span className="text-[10px] font-semibold uppercase tracking-wider text-ink-dim">
                Badge Preview
              </span>
              <div className="relative flex h-36 w-36 items-center justify-center overflow-hidden rounded-full ring-2 ring-accent/30 sm:h-40 sm:w-40">
                {thumbUrl ? (
                  <Image
                    src={thumbUrl}
