...
const nextConfig = {
  ...
  allowedDevOrigins: [
    "disabilities-drill-conducted-advocate.trycloudflare.com",
    "were-proudly-mesh-cowboy.trycloudflare.com",
  ],
  experimental: {
    ...
    return [
      {
        ...
        headers: [
          ...
          { key: "Strict-Transport-Security", value: "max-age=63072000; includeSubDomains; preload" },
          {
            ...
            value: [
              "default-src 'self'",
              "script-src 'self' 'unsafe-inline' 'unsafe-eval' https://us-assets.i.posthog.com blob:",
